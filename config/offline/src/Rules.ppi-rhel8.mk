...
#
OPT_BASE  = -fdefault-real-8 -fdefault-double-8 -g -fno-second-underscore -fpic  -ffpe-trap=overflow,zero,invalid -fbacktrace -fconvert=swap -fallow-argument-mismatch
#
OPT_PERF0 = -O0
OPT_PERF2 = -O2
...
#
F90FLAGS      = $(FCFLAGS_OMP) $(OPT) -ffree-line-length-none
F77 = $(F90)
F77FLAGS      = $(FCFLAGS_OMP) $(OPT) -ffree-line-length-none
FX90 = $(F90)
FX90FLAGS     = $(FCFLAGS_OMP) $(OPT) -ffree-line-length-none
#
LDFLAGS   =  $(FCFLAGS_OMP) -Wl,-warn-once -ldl -lrt 
#
# preprocessing flags
#
CPP = cpp -P -traditional -Wcomment -I/modules/rhel8/user-apps/openmpi/4.1.4/include/
#
FPPFLAGS_SURFEX    =
